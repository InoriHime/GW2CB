...
import Modelo.ModeloNuevoPersonaje;
...
public class ControladorNuevoPersonaje implements ActionListener {
    ...
    ControladorNuevoPersonaje(Personaje p, VentanaPrincipal v) {

        this.vista = v;
        this.personaje = p;
        this.modelo = new ModeloNuevoPersonaje();
    ...
    public void prepararDatosPersonaje(){
        armas = new int[6][6];
        armaduras = new int[13][5];
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (AccionMVC.valueOf(e.getActionCommand())) {
            ...
            case __MODIFICAR_PERSONAJE:
                ...
                modelo.crearPersonaje(this.vista.txt_dialogoMP_Nombre.getText(), personaje.getClase(), raza, clase, armas, armaduras, nuevoArma, eliminarArma, nuevoArmadura, eliminarArmadura);
